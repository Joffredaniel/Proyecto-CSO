...
<body>
    ...
    <?php if (count($reparaciones) === 0): ?>
        <tr><td colspan="8" style="text-align:center;">No hay reparaciones.</td></tr>
    <?php else: ?>
        <?php foreach ($reparaciones as $rep): ?>
            <tr>
                ...
                <td>
                    <a href="editar_reparacion.php?id=<?php echo $rep['id_reparacion']; ?>" class="btn-editar">Editar</a> |
                    <a href="eliminar_reparacion.php?id=<?php echo $rep['id_reparacion']; ?>" class="btn-eliminar" onclick="return confirm('¿Estás seguro de eliminar esta reparación?')">Eliminar</a>|
                    <a href="generar_factura.php?id=<?php echo $rep['id_reparacion']; ?>">Generar Factura</a>
